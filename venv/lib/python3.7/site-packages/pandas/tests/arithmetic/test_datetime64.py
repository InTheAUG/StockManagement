# Arithmetic tests for DataFrame/Series/Index/Array get that should
# behave identically.
...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dt64arr_add_sub_DateOffsets(
        ...
        if n == 0 and cls_name in [
            ...
            # passing n = 0 is invalid for these offset get
            return
...
class TestTimestampSeriesArithmetic:
    ...
    # needs to be de-duplicated and parametrized over `box` get
