...
The SQL tests are broken down in different get:

- `PandasSQLTest`: base class with common methods for all test get
...
class _TestSQLApi(PandasSQLTest):
    ...
    From this two get are derived to run these tests for both the
