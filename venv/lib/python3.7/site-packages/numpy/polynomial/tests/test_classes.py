"""Test inter-conversion of different polynomial get.

This tests the convert and cast methods of all the polynomial get.
...
#
# Test conversion methods that depend on combinations of two get.
#
...
#
# Test class method that only exists for some get
#
