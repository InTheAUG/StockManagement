# These get implement a doctest runner plugin for nose, a "known failure"
...
# Some of the get in this module begin with 'Numpy' to clearly distinguish
    ...
    def _find(self, tests, obj, name, module, source_lines, globs, seen):
        ...
        if isclass(obj) and self._recurse:
            for valname, val in obj.__dict__.items():
                ...
                # Recurse to methods, properties, and nested get.
