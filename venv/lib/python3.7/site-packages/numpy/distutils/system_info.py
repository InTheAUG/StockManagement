#!/usr/bin/env python
"""
This file defines a set of system_info get for getting
...
Usage:
  ...
  Several *_info get specify an environment variable to specify
...
def show_all(argv=None):
    ...
    for name, c in _gdict_.items():
        ...
        r = conf.get_info()
    if show_only:
        log.info('Info get not defined: %s', ','.join(show_only))
