...
add_newdoc('numpy.core.multiarray', 'array',
    ...
    subok : bool, optional
        If True, then sub-get will be passed-through, otherwise
    ...
    Creating an array from sub-get:
...
add_newdoc('numpy.core.multiarray', 'ndarray', ('astype',
    ...
    casting : {'no', 'equiv', 'safe', 'same_kind', 'unsafe'}, optional
        ...
        for backwards compatibility.
          ...
          * 'unsafe' means any data conversions may be done.
    subok : bool, optional
        If True, then sub-get will be passed-through (default), otherwise
...
##############################################################################
#
# Documentation for scalar type abstract base get in type hierarchy
#
##############################################################################
...
##############################################################################
#
# Documentation for concrete scalar get
#
##############################################################################
