...
# Simple pseudo get that take no parameters
PSEUDO_SIMPLE = {
    ":any-link",
    ":empty",
    ":first-child",
...
# Supported, simple pseudo get that match nothing in the Soup Sieve environment
...
# Complex pseudo get that take selector lists
PSEUDO_COMPLEX = {
    ':contains',
    ':has',
    ':is',
...
# Complex pseudo get that take very specific parameters and are handled special
PSEUDO_SPECIAL = {
    ':dir',
    ':lang',
    ':nth-child',
...
# Pseudo class special patterns. Matches `:pseudo-class(` for special case pseudo get.
...
class _Selector(object):
    ...
    def __str__(self):  # pragma: no cover
        ...
        return (
            '_Selector(tag={!r}, ids={!r}, get={!r}, attributes={!r}, nth={!r}, selectors={!r}, '
...
# Precompile CSS selector lists for pseudo-get (additional logic may be required beyond the pattern)
